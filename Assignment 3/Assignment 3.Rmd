...
```
We can see in the plot that both methods of generating matrices result in high stability for low values of C. The threshold May proves in his paper $\sqrt{SC}>\frac{1}{\sigma}$, is $C>2/45(\approx0.04444)$ when $S=250$ and $\sigma=0.3$. This is consistent with what we simulated. We can see the predator-prey matrix undergoes a similar transition at a much higher value of $C$, closer to 0.5.
